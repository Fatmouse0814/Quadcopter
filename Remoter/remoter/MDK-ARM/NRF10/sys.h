...
#define GPIOJ_ODR_ADDr    (GPIOJ_BASE+12) //0x40022414
#define GPIOK_ODR_ADDr    (GPIOK_BASE+12) //0x40022814
...
#define GPIOJ_IDR_Addr    (GPIOJ_BASE+8) //0x40022410 
#define GPIOK_IDR_Addr    (GPIOK_BASE+8) //0x40022810 
